...
| [`research/2026-07-pertine-round3-residual-decay-replacement.md`](research/2026-07-pertine-round3-residual-decay-replacement.md) | 第 3 巡設計: residual-decay 連鎖の per-tine 置換 (#206、merge 条件 3。probe 実測付き) |
