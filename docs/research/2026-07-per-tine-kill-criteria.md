...
| K6 | hard-kill | 期間 | S5-S7 の 3 スプリント、**または S5 実装開始から 30 暦日のいずれか早い方**で merge 判断材料 (K2-K4 の判定) が揃わない (2026-07-05 改訂、ユーザー承認済み — 上の S4 節参照) | 無期限 research 化の防止。スプリントが GO 区切りになったため壁時計上限を併設 |
