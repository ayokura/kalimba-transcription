...
# Terminal-orphan and gap-head collectors.
...
# Feature flags and ablation switches.
...
CARRYOVER_MUTE_DIP_MIN_BACKWARD_ATTACK_GAIN = 2.0
...
USE_ITERATIVE_HARMONIC_SUPPRESSION = True
